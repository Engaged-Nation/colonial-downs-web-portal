...
EngagedNation.RequireJS.define(
    ...
    function($, LbxGrid)
    {
         ...
         */
        var TachiTabletLbxGrid = function(config)
        {
            this.config = {
         ...
         * Add methods
         */
        TachiTabletLbxGrid.prototype = $.extend(
        ...
        {
            EngagedNation.jQuery.extensions.TachiTabletLbxGrid = new TachiTabletLbxGrid(config);
        };
