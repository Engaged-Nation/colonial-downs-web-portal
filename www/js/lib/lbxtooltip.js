...
EngagedNation.RequireJS.define(
    ...
    function($, LbxToolTip)
    {
         ...
         */
        var TachiTabletLbxToolTip = function(config)
        {
         ...
         * Add methods
         */
        TachiTabletLbxToolTip.prototype = $.extend(
        ...
        {
            EngagedNation.jQuery.extensions.TachiTabletLbxToolTip = new TachiTabletLbxToolTip(config);
        };

        return TachiTabletLbxToolTip;
    }
);
